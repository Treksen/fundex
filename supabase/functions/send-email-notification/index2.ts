...
const FROM_EMAIL = Deno.env.get('FROM_EMAIL') ?? 'Fundex Savings & Investments <info@geotreks.co.ke>'
const APP_URL = Deno.env.get('APP_URL') ?? 'https://finance.geotreks.co.ke'
